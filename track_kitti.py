...
sequence_path = "/datasets/kitti/dataset/sequences/06"
...
# Setup rerun visualizer
rr.init('kitti', strict=True, spawn=False)  # spawn=False is the magic word here!
# rr.save("kitti_06_map.rrd")  # Save it directly to a file
rr.connect_tcp()
...
for frame in range(len(timestamps)):
    print(f"Processing frame {frame}...") # <--- ADD THIS LINE!
